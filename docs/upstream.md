# Upstream esbuild introduction

The following introduction is retained from evanw/esbuild at revision `f6058f8364fe7ab91ca57a83e02577ed74c9cae4`. Image paths are adjusted for this document location. Its performance statements describe the upstream project, not a benchmark performed by Beyond. The [MIT license](../LICENSE.md) and upstream attribution remain intact.
