...
## Accepted scope and exceptions

Upstream esbuild sources, generated code and third-party packages retain their original style and layout. These standards apply to new Beyond-authored assessment code, not to an unsolicited upstream rewrite. Small language fixtures intentionally contain functions and source patterns required by their tests. Generated runtime artifacts are exempt.
